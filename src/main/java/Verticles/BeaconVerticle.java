 ...
 */
public class BeaconVerticle extends AgentVerticle {
    public BeaconVerticle(String owner_, String id_, Position position_) {
...
//        commands.put("ion", new Date().getTime());
//        commands.put("laser", new Date().getTime());
